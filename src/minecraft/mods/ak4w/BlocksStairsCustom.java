...
public class BlocksStairsCustom extends Block
{
    ...
    protected BlocksStairsCustom(int par1, Block par2Block, int par3)
    {
    ...
    /**
     * Checks if supplied ID is one of a BlocksStairsCustom
     */
    public static boolean isBlocksStairsCustomID(int par0)
    {
        return par0 > 0 && Block.blocksList[par0] instanceof BlocksStairsCustom;
    }

    private boolean func_82540_f(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        int i1 = par1IBlockAccess.getBlockId(par2, par3, par4);
        return isBlocksStairsCustomID(i1) && par1IBlockAccess.getBlockMetadata(par2, par3, par4) == par5;
    }
    ...
    public boolean func_82542_g(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if (i1 == 0)
        {
            ...
            if (isBlocksStairsCustomID(j1) && (l & 4) == (k1 & 4))
            {
                l1 = k1 & 3;
